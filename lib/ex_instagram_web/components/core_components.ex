defmodule ExInstagramWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExInstagramWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExInstagramWeb.Gettext, "errors", msg, opts)
    end
  end
