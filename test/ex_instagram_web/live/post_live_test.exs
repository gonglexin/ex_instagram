defmodule ExInstagramWeb.PostLiveTest do
  use ExInstagramWeb.ConnCase

  import Phoenix.LiveViewTest
  import ExInstagram.TimelineFixtures

  @create_attrs %{images: ["option1", "option2"], caption: "some caption"}
  @update_attrs %{images: ["option1"], caption: "some updated caption"}
  @invalid_attrs %{images: [], caption: nil}
